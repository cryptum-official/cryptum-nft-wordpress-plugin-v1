...
function cryptum_nft_plugin_loaded()
{
	...
	add_action('woocommerce_product_data_panels', function() {
		?><div id="cryptum_nft_options" class="panel woocommerce_options_panel hidden"><?php
...
{
	$settings_link = '<a href="options-general.php?page=cryptum-nft&t=general">' . __('Settings', 'cryptum-nft') . '</a>';
